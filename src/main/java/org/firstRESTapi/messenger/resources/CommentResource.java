...
import org.firstRESTapi.messenger.service.CommentService;
...
public class CommentResource {
	...
	@DELETE
	@Path("/{commentId}")
	public void deleteMessage(@PathParam("messageId") long messageId, @PathParam("commentId") long id) {
		commentService.removeComment(messageId, id);
	}
	
	@Path("/{commentId}")
	public Comment getComment(@PathParam("messageId") long messageId, @PathParam("commentId") long id) {
